...
/***/ function(module, exports, __webpack_require__) {
	...
	var Repos = React.createClass({
	  ...
	  loadRepoData: function loadRepoData() {
	    $.ajax({
	  ...
	  render: function render() {
	    ...
	    return React.createElement(
	      ...
	      React.createElement(
	        'p',
	        null,
	        'I tried to get my repos to show, but react is wierd. check console for objects'
	      )
	    );
	  }
	});

	ReactDOM.render(React.createElement(App, null), document.getElementById('header'));
	ReactDOM.render(React.createElement(Profile, { source: 'https://api.github.com/users/ho-luc' }), document.getElementById('content'));
	ReactDOM.render(React.createElement(Repos, { source: 'https://api.github.com/users/Ho-Luc/repos' }), document.getElementById('repos'));
